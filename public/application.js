...
/***/ (function(module, exports, __webpack_require__) {
	...
	var authEvents = __webpack_require__(158);
	var meetingEvents = __webpack_require__(164);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://sleepy-bayou-40417.herokuapp.com',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	//
	);var renderView = function renderView(element, hbsFile, params) {
	  var template = __webpack_require__(9)("./" + hbsFile + '.handlebars');
	...
	var replaceView = function replaceView(element, hbsFile, params) {
	  var template = __webpack_require__(9)("./" + hbsFile + '.handlebars');
	  var content = template(params);
	...
	var appendView = function appendView(element, hbsFile, params) {
	  var template = __webpack_require__(9)("./" + hbsFile + '.handlebars');
	  var content = template(params);
	...
	var prependView = function prependView(element, hbsFile, params) {
	  var template = __webpack_require__(9)("./" + hbsFile + '.handlebars');
	  var content = template(params);
	...
	var clearView = function clearView(element) {
	  $(element).html('');
	};
	...
	var setSignedOutMode = function setSignedOutMode() {
	  // closeAlert()
	...
	var setSignedInMode = function setSignedInMode() {
	  // closeAlert()
	...
	var showAuth = function showAuth(inOrUp) {
	  if (inOrUp === 'signin') {
	...
	var showMeetups = function showMeetups(meetups, div) {
	...
	module.exports = {
	  initView: initView,
	  setSignedOutMode: setSignedOutMode,
	  setSignedInMode: setSignedInMode,
	  showAlert: showAlert,
	  formAlert: formAlert,
	  clearForm: clearForm,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var map = {
		"./alert.handlebars": 10,
		"./confirm-email.handlebars": 30,
		"./form-auth.handlebars": 31,
		"./form-change-password.handlebars": 32,
		"./nav-si.handlebars": 33,
		"./nav-so.handlebars": 34,
		"./search-bar.handlebars": 35,
		"./search-page.handlebars": 36,
		"./show-all-meetups.handlebars": 37,
		"./show-my-meetups.handlebars": 157
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"alert alert-"
	    ...
	    + " alert-dismissable fade in\" id=\"delete-modal\">\n  <a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">&times;</a>\n  "
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n  <!-- layout for sign in panel -->\n  <div class=\"panel panel-default\">\n    <div class=\"panel-body\">\n      <!-- POST	/sign-in	users#signin -->\n      <form id=\"confirm-email\" class=\"form\">\n        <fieldset>\n          <legend>Confirm email address</legend>\n          <div class=\"form-group\">\n            <label for=\"sign-in-email\">Email</label>\n            <div class=\"input-group\">\n              <input type=\"email\" class=\"form-control\" name=\"credentials[email]\"  placeholder=\""
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"container\">\n  <div class=\"navbar-header\">\n    <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbar-collapse\">\n      <span class=\"sr-only\">Toggle navigation</span>\n      <span class=\"icon-bar\"></span>\n      <span class=\"icon-bar\"></span>\n      <span class=\"icon-bar\"></span>\n    </button>\n    <span class=\"navbar-brand\">peek @ meets</span>\n  </div>\n  <div class=\"collapse navbar-collapse\" id=\"navbar-collapse\">\n    <ul class=\"nav navbar-nav navbar-right\">\n      <li>\n        <a href=\"#\" type=\"button\" class=\"btn btn-link\" id=\"show-mypeeks-btn\">My Peeks</a>\n      </li>\n      <li>\n        <a href=\"#\" type=\"button\" class=\"btn btn-link\" id=\"peek-search-btn\">Peek!</a>\n      </li>\n      <li class=\"dropdown\">\n        <a href=\"#\" type=\"button\" class=\"btn btn-link dropdown-toggle\" data-toggle=\"dropdown\" id=\"change-password-nav\"> Change Password <span class=\"caret\"></span></a>\n        <div id=\"change-password-dropdown\" class=\"dropdown-menu\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(32),depth0,{"name":"form-change-password","data":data,"indent":"            ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "        </div>\n      </li>\n      <li>\n        <a href=\"#\" type=\"button\" class=\"btn btn-link\" id=\"sign-out-btn\"> Sign Out</a>\n      </li>\n    </ul>\n  </div>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"container\">\n  <div class=\"navbar-header\">\n    <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbar-collapse\">\n      <span class=\"sr-only\">Toggle navigation</span>\n      <span class=\"icon-bar\"></span>\n      <span class=\"icon-bar\"></span>\n      <span class=\"icon-bar\"></span>\n    </button>\n    <span class=\"navbar-brand\">peek @ meets</span>\n  </div>\n\n  <div class=\"collapse navbar-collapse\" id=\"navbar-collapse\">\n    <ul class=\"nav navbar-nav navbar-right\">\n      <li>\n        <a href=\"#\" type=\"button\" class=\"btn btn-link\" id=\"sign-up-btn\">Sign up</a>\n      </li>\n      <li>\n        <a href=\"#\" type=\"button\" class=\"btn btn-link\" id=\"sign-in-btn\"> Sign in</a>\n      </li>\n    </ul>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return "    <h3>Take a peek at what tech meetups are out there</h3>\n";
	},"3":function(container,depth0,helpers,partials,data) {
	    return "    <h3>Take a peek at what tech meetups are out there</h3>\n    <p>...or sign in and check your saved meetups</p>\n";
	  ...
	  return "<div>\n"
	    ...
	    + "\n<div class=\"container center\">\n  <form id=\"m-search\" class=\"form-inline\">\n    <div class=\"form-group col-sm-offset-1\" align=\"center\">\n      <label for=\"m-location\">Location</label>\n      <input type=\"number\" class=\"form-control\"  name=\"m_search[location]\" id=\"m_location_place\" placeholder=\"02110\" value=\"02110\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"m_radius\">radius</label>\n      <input type=\"number\" class=\"form-control\" name=\"m_location[radius]\" id=\"m_location_radius\" placeholder=\"5\" value=\"5\">\n    </div>\n    <button type=\"submit\" class=\"btn btn-default search-btn\">Search</button>\n  </form>\n</div>\n\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div>\n  <h2>Take a peek at what tech meetups are out there</h2>\n  <div class=\"panel-body\">\n    <!-- search for meetups -->\n    <form id=\"m-search\" class=\"form\">\n      <fieldset>\n        <div class=\"form-group\">\n          <label for=\"m-location\" class=\"sr-only\">Location</label>\n          <div class=\"input-group\">\n            <input type=\"location\" class=\"form-control\" name=\"m_search[location]\" id=\"m_location_place\" placeholder=\"02110\" value=\"02110\">\n          </div>\n          <p class=\"help-block\">Please enter a city or zip code.</p>\n        </div>\n        <div class=\"form-group\">\n          <label for=\"m_radius\" class=\"sr-only\">Radius</label>\n          <div class=\"input-group\">\n            <input type=\"m_radius\" class=\"form-control\" name=\"m_location[radius]\" id=\"m_location_radius\" placeholder=\"5\" value=\"5\">\n          </div>\n          <p class=\"help-block\">Please enter distance in miles.</p>\n        </div>\n        <div class=\"text-center\">\n          <button type=\"submit\" class=\"btn btn-primary\">Search</button>\n        </div>\n      </fieldset>\n    </form>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <h2>Search results</h2>\n  <div class=\"row\">\n    <div class=\"col-sm-3\"><h4>Date</h4></div>\n    <div class=\"col-sm-7\"><h4>Meetup</h4></div>\n  </div>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.data : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.escapeExpression, alias3=container.lambda;

	  return "      <div class=\"row\">\n         <div class=\"col-sm-3\" >\n           <h6>"
	    + alias2(__default(__webpack_require__(38)).call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.time : stack1),"hh:mm a",{"name":"formatTime","hash":{},"data":data,"blockParams":blockParams}))
	    + "</h6>\n           <h4>"
	    + alias2(__default(__webpack_require__(38)).call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.time : stack1),"MMMM Do",{"name":"formatTime","hash":{},"data":data,"blockParams":blockParams}))
	    + "</h4>\n         </div>\n         <div class=\"col-sm-7\" >\n           <h6>"
	    + alias2(alias3(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.group : stack1)) != null ? stack1.name : stack1), depth0))
	    + "</h6>\n           <h4><a href=\""
	    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.event_url : stack1), depth0))
	    + "\" target=\"_blank\">"
	    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</a></h4>\n         </div>\n         <div class=\"col-sm-2\">\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.user : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0, blockParams),"inverse":container.program(5, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "         </div>\n       </div>\n";
	},"3":function(container,depth0,helpers,partials,data) {
	    return "             <a class=\"btn btn-xs btn-warning\" id=\"meetup-remind-me\" role=\"button\">Remind me!</a>\n";
	},"5":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "             <button class=\"btn btn-xs btn-warning\" meetup-id=\""
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" id=\"meetup-remind-me\" role=\"button\"\n             data-toggle=\"popover\" data-placement=\"left\" data-trigger=\"focus\" title=\"Not so fast...\"\n             data-content=\"You must be signed in to save reminders.\">Remind me!</button>\n";
	},"7":function(container,depth0,helpers,partials,data) {
	    return "    <h2>You have no meetups! Sad!</h2>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n<div>\n\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.data : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(7, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var formatTime = function formatTime(date, format) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <h2>My peeks</h2>\n  <button type=\"click\" id=\"send-email-btn\" class=\"btn btn-default btn-primary\">Send Reminder Email</button>\n\n  <div class=\"row\">\n    <div class=\"col-sm-3\"><h4>Date</h4></div>\n    <div class=\"col-sm-7\"><h4>Meetup</h4></div>\n  </div>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.data : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.escapeExpression, alias3=container.lambda;
	  ...
	  return "    <div class=\"row\">\n       <div class=\"col-sm-3\" >\n         <h6>"
	    ...
	    + alias2(__default(__webpack_require__(38)).call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.time : stack1),"MMMM Do",{"name":"formatTime","hash":{},"data":data,"blockParams":blockParams}))
	    + "</h4>\n       </div>\n       <div class=\"col-sm-7\" >\n         <h6>"
	    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.group : stack1), depth0))
	    + "</h6>\n         <h4><a href=\""
	    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.event_url : stack1), depth0))
	    + "\" target=\"_blank\">"
	    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</a></h4>\n       </div>\n       <div class=\"col-sm-2\">\n         <button class=\"btn btn-xs btn-danger\" meetup-id=\""
	    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" id=\"meetup-cancel-reminder\"\n           role=\"button\">Cancel reminder!</button>\n       </div>\n     </div>\n";
	  ...
	  return "\n<div>\n\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.data : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n</div>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(159);

	var authApi = __webpack_require__(160);
	var authUi = __webpack_require__(161);
	var meetupsApi = __webpack_require__(162);
	var meetupsUi = __webpack_require__(163);
	var view = __webpack_require__(7);
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  ();if (!data.credentials.email) {
	    ...
	    authApi.signUp(data).then(authUi.signUpSuccess
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  ();if (!data.credentials.email) {
	    ...
	    authApi.signIn(data).then(authUi.signInSuccess).then(function () {
	      meetupsApi.getMyMeetups().then(meetupsUi.getMyMeetupsSuccess).catch(meetupsUi.getMyMeetupsFailure);
	...
	var onUpdateEmail = function onUpdateEmail(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();

	  authApi.updateEmail(data).then(authUi.updateEmailSuccess).catch(authUi.updateEmailFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateEmailSuccess = function updateEmailSuccess(response) {
	...
	var updateEmailFailure = function updateEmailFailure() {
	  // need to make that form go away
	...
	module.exports = {
	  ...
	  updateEmailFailure: updateEmailFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getMyMeetups = function getMyMeetups() {
	  var rv = $.ajax({
	...
	var searchMeetups = function searchMeetups(data) {
	  return $.ajax({
	...
	var createMeetup = function createMeetup(data) {
	  return $.ajax({
	...
	var deleteMeetup = function deleteMeetup(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/meetups/' + data,
	    method: 'DELETE',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getMyMeetupsSuccess = function getMyMeetupsSuccess(response) {
	  view.showMeetups(response.meetups, '.my-meetups-div');
	};

	var getMyMeetupsFailure = function getMyMeetupsFailure() {
	  view.showAlert('error', 'Couldn\'t get your list of meetups...');
	};

	var searchMeetupsSuccess = function searchMeetupsSuccess(response) {
	  view.showMeetups(response.results, '.all-meetups-div');
	};

	var searchMeetupsFailure = function searchMeetupsFailure() {
	  view.showAlert('error', 'Hmmm. Couldn\'t search the meetups...');
	};

	var createMeetupFailure = function createMeetupFailure() {
	  view.showAlert('error', 'Hmmm. Couldn\'t create the meetup...');
	};

	var createMeetupSuccess = function createMeetupSuccess() {};

	var deleteMeetupFailure = function deleteMeetupFailure() {
	  view.showAlert('error', 'Couldn\'t cancel that reminder.');
	};

	var deleteMeetupSuccess = function deleteMeetupSuccess() {};

	var sendEmailFailure = function sendEmailFailure() {
	  view.showAlert('error', 'Couldn\'t email your reminders.');
	};

	var sendEmailSuccess = function sendEmailSuccess() {
	...
	module.exports = {
	  ...
	  getMyMeetupsSuccess: getMyMeetupsSuccess,
	  getMyMeetupsFailure: getMyMeetupsFailure,
	  createMeetupSuccess: createMeetupSuccess,
	  createMeetupFailure: createMeetupFailure,
	  deleteMeetupSuccess: deleteMeetupSuccess,
	  deleteMeetupFailure: deleteMeetupFailure,
	  searchMeetupsSuccess: searchMeetupsSuccess,
	  searchMeetupsFailure: searchMeetupsFailure
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetMyMeetups = function onGetMyMeetups(event) {
	  event.preventDefault();
	  if (!isSignedIn()) {
	...
	var onSearchMeetups = function onSearchMeetups(event) {
	  event.preventDefault();
	  var data = getFormFields(this
	  // make sure it's a zip code for now
	  );if (/^([0-9]{5})$/.test(data.m_search.location)) {
	    view.clearView('.info-div');
	    meetupsApi.searchMeetups(data).then(meetupsUi.searchMeetupsSuccess).catch(meetupsUi.searchMeetupsFailure);
	  } else {
	    view.showAlert('error', 'That is not a zip code');
	  }
	};

	var onRemind = function onRemind(event) {
	  event.preventDefault();
	  if (isSignedIn()) {
	    var meetupId = $(this).attr('meetup-id');
	    meetupsApi.createMeetup(meetupId).then(meetupsUi.createMeetupSuccess).catch(meetupsUi.createMeetupFailure);
	  }
	};

	var onCancelReminder = function onCancelReminder(event) {
	  event.preventDefault();
	  var meetupId = $(this).attr('meetup-id');
	  meetupsApi.deleteMeetup(meetupId).then(meetupsUi.deleteMeetupSuccess).then(function () {
	    meetupsApi.getMyMeetups().then(meetupsUi.getMyMeetupsSuccess).catch(meetupsUi.getMyMeetupsFailure);
	  }).catch(meetupsUi.deleteMeetupFailure);
	};

	var onSendReminderEmail = function onSendReminderEmail(event) {
	  event.preventDefault
	  //  make sure we have a good email to send to
	  ();if (!store.user.verified_reminder_email) {
	    view.confirmEmail();
	  } else {
	    meetupsApi.sendEmail().then(meetupsUi.sendEmailSuccess).catch(meetupsUi.sendEmailFailure);
	  }
	};
